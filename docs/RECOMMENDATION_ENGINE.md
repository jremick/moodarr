...
- Local-first does not mean zero egress because Plex, Seerr, and TMDB poster flows remain. Source provider testing can additionally send the bounded inputs documented in `DATA_AND_PRIVACY.md`; the official beta.1 image cannot.
