...
- Complete combined verification and CI for the locally integrated multi-season TV input and preview invalidation before delivery; see [the validation record](PLEX_AND_TV_REQUEST_VALIDATION_2026_09.md).
