...
- Removed the redundant **Available in Plex** card pill so the existing **Open Plex** action is the single availability signal, while meaningful Seerr request-state pills remain visible.
