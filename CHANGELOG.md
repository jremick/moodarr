...
- Hardened the provisional source embedding path so incompatible cached vectors are detected, excluded from retrieval, and gradually replaced without loading the entire catalog into memory; the official beta.1 image remains provider-locked.
