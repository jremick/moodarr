        ...
        <section className="admin-panel">
          ...
          <fieldset className="admin-settings-body" disabled={!adminLoaded || adminLoading || busy === "admin-save"}>
            ...
            <fieldset>
              ...
              {!openAiConfigurable ? (
                <>
                  <p className="panel-copy">This beta build uses local ranking only. The OpenAI network endpoint is excluded from the release server bundle; configurable source builds can still test it.</p>
